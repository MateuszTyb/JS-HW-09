...
function x() {
  setInterval(ms => {
    let today = new Date().getTime(); // Number of milliseconds per unit of time

    const second = 1000;
    const minute = second * 60;
    const hour = minute * 60;
    const day = hour * 24;
    ms = chosenDate - today; // Remaining days
...
},{"flatpickr":"../node_modules/flatpickr/dist/esm/index.js","notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.2.min.js","flatpickr/dist/flatpickr.min.css":"../node_modules/flatpickr/dist/flatpickr.min.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
